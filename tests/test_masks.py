...
@pytest.mark.parametrize(
    ...
    [
        ...
        (" ", "Некорректный номер карты, пожалуйста введите верный номер карты"),
        ("йцукенгшщзхъфыва", "Некорректный номер карты, пожалуйста введите верный номер карты"),
        ("123456789123456789", "Некорректный номер карты, пожалуйста введите верный номер карты"),
        ("print('жалкая попытка взлома')", "Некорректный номер карты, пожалуйста введите верный номер карты")
    ],
)
